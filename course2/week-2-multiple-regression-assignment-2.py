...
print("Simple weights: " + str(simple_weights))
...
print("Test predictions for 1st house in test set: " + str(simple_predictions[0]))

# Now that you have the predictions on test data, compute the RSS on the test data set. Save this value for comparison later. Recall that RSS is the sum of the squared errors (difference between prediction and output).

# In[ ]:

test_residuals = simple_predictions - test_output
test_rss = (test_residuals**2).sum()
print("Test RSS: " + str(test_rss))
...
weights = regression_gradient_descent(feature_matrix, output,
                                      initial_weights, step_size, tolerance)
print("Weights for feature matrix: " + str(weights))
...
print("Predicted price of 1st TEST house: " + str(predictions[0]))
...
print("Actual price of 1st TEST house: " + str(test_data['price'][0]))
