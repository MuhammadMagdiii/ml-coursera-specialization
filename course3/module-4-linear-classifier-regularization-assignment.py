...
featsL20 = table['word', 'coefficients [L2=0]']
featsL20 = featsL20.sort('coefficients [L2=0]', ascending=False)
positive_words = featsL20['word'][0:5]
positive_words


featsL20 = featsL20.sort('coefficients [L2=0]', ascending=True)
negative_words = featsL20['word'][0:5]
negative_words
